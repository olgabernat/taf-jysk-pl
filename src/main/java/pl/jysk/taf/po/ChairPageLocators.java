...
public class ChairPageLocators {
    ...
    public static final String MIN_PRICE_FILTER_LOCATOR = "//input[@placeholder='Min']";
    ...
    public static final String CHAIR_TEXT_LOCATOR = "//a[@class = 'product-teaser-title text-reset']";
